---
layout: post
title: Gerando Bytearray de 0x00 a 0xFF utilizando bash
date: 2020-04-29 21:21:50.000000000 -03:00
type: post
parent_id: '0'
published: true
password: ''
...
permalink: "/it/gerando-bytearray-de-0x00-a-0xff-utilizando-bash/"
---

Com o comando abaixo é possível gerar um arquivo binário contendo os bytes de 0x00 a 0xff

```shell
for i in {0..255}; do hex=$(printf %1x "$i"); echo -e -n "\x$hex"; done > bytearray.bin
```
